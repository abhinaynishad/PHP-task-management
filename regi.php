...
if (isset($_POST['register'])) {
    ...
    if (empty($name) || empty($email) || empty($password)) {
      ...
      $check = mysqli_query($conn, "SELECT * FROM loginpage WHERE email='$email'");
       if (mysqli_num_rows($check) > 0) {
            echo "Email already registered!";
        }else{
                $sql = "INSERT INTO loginpage (name, email, password) VALUES ('$name', '$email', '$hashedPassword')";
    ...
    <!-- <div class="container">
        ...
        <!-- <form action="#">
            ...
            <div class="reg_btn">
             ...
             <p>you have a account please <a href="login.php">login??</a> </p>
        </form>
    </div> -->
<!-- 
 <div class="container">
